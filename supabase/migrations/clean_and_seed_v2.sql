-- ==============================================================================
-- CLEAN AND SEED SCRIPT (v2 - FIXED)
...
BEGIN
    -- 1. TRUNCATE DATA (CASCADE to remove related rows)
    -- We do not truncate auth.users as we cannot re-create them easily with passwords via SQL alone.
    -- We assume the users 'mah@hotmail.com' and 'telemed_patient@test.com' exist in Authentication.
