...
async function check() {
    const { error: insertError } = await supabase.from('medical_documents').insert({ title: 'test' }).select();
    console.log('Insert error msg:', insertError ? insertError.message : 'Success (unexpected)');
}
